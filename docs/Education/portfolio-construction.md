...
This concept of ‘stacking’ return streams on top of each other as shown in the Alpha-Beta pyramid is not new. It has been used by sophisticated institutional investors for decades, one variant of which is known as ‘portable alpha’[[5](https://www.amazon.com/Portable-Alpha-Theory-Practice-Investors/dp/0470118083)][[6](https://www.panagora.com/wp-content/uploads/JPM-Portable-Alpha.pdf)][[7](https://www.man.com/insights/portable-alpha-solving-magnificent-problem)][ ](https://www.panagora.com/wp-content/uploads/JPM-Portable-Alpha.pdf). Lastly, the separation of alphas (active strategies) from betas (passive strategies) is not just an important conceptual framework for building better performing portfolios, it can also have practical implications for tax benefits [[8](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3178273)].
